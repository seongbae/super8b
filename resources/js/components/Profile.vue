      ...
      <div class="card-body">
        <form class="form-horizontal">
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <input class="form-control" :class="{'is-invalid': errors.name}" type="text" v-model="user.name" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <input class="form-control" :class="{'is-invalid': errors.email}" type="email" v-model="user.email" required>
...
export default {
  ...
  methods: {
    ...
    updateAuthUser () {
      this.submiting = true
      axios.put('/api/user/updateAuthUser', this.user)
      .then(response => {
        this.errors = {}
